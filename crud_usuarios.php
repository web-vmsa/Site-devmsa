...
<body>
	...
	<div class="github">
		<div class="git">
			...
			<br>
			<a href="https://github.com/web-vmsa/projetos/tree/master/CRUD" style="padding: 7px; color: white; background-color: black; border-radius: 3px; text-decoration: none;">GitHub</a><br><br>
		</div>
	</div>
