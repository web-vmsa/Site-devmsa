...
<body>
	...
	<div class="projeto">
		<div class="projetoint">
			...
			<br>
			<img src="../Imagens/cadastro.png" border="0" width="300" height="300"><br><br>
		</div>
	</div>
	...
	<div class="projeto2">
		<div class="projetoint2">
			...
			<video preload controls muted width="500" height="400" style="background-color: red;">
				<source src="../Videos/cadastro.mp4" type="video/mp4">
			</video><br><br>
		</div>
	</div>
	...
	<div class="github">
		<div class="git">
			...
			<br>
			<a href="https://github.com/web-vmsa/projetos/tree/master/cadastro" style="padding: 7px; color: white; background-color: black; border-radius: 3px; text-decoration: none;">GitHub</a><br><br>
		</div>
	</div>
